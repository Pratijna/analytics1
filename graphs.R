...
women
plot(women)
plot(women, type='l', pch=18, col='yellow')
plot(women, type='l')
plot(women, type='b')
...
plot(x=women$weight, y=women$height, pch=20, xlab='Weight', ylab='Height', col='red', cex=2, type='l')
title(main='Main Title', sub='Sub Title')
#see cheat sheet on base graphs
?plot
plot(women)
abline(lm(women$weight ~ women$height), col='red', lty=2, lwd=1)
